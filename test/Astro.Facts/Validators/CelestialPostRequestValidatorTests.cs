...
{
    public class CelestialPostRequestValidatorTests
    {
        ...
        {
            var validator = new CelestialPostRequestValidator();
        ...
        {
            var obj = new CelestialPostRequestModel
            {
                Name = "Test",
                Magnitude = 1.1,
        ...
        public void When_Distances_Is_Empty_Then_Should_Have_Error()
        {
            var obj = new CelestialPostRequestModel
            {
                ...
                Designation4 = "test",
                ObjectType = ObjectType.Galaxy,
                Distances = new List<DistancePostRequestModel>()
            };
